      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            SkyNetics empowers researchers and enthusiasts with professional-grade tools for astronomical analysis.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <Card className="p-8 rounded-2xl bg-white/5 border-white/10 hover:border-cyan-500/30 hover:bg-white/10 hover:shadow-[0_0_20px_rgba(0,240,255,0.9),0_0_20px_rgba(0,200,255,0.8),0_0_30px_rgba(0,180,255,0.6)]

 transition-all duration-300 group backdrop-blur-sm shadow-none gap-0 hover:-translate-y-5">
